...
export const inputAmount = parseUnits("5", 6);
...
export const kyberTokenIn = "0xaf88d065e77c8cC2239327C5EDb3A432268e5831";

// Token used as output for the Kyberswap swap on the destination chain.
export const kyberTokenOut = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";

// Slippage tolerance for the Kyberswap swap on the destination chain.
export const destinationSwapSlippageBps = 50;
